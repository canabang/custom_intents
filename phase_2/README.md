...
Le système repose sur une convention de nommage stricte. Pour que la détection automatique fonctionne, vos entités **doivent** suivre ce format ou un format similaire , a vous d'adapter en conséquence :
